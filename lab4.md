...
**Step 5:**  
Keys:  I typed "git clone" and pressed cmnd-V to paste "git@github.com:jmmendelson/lab7.git" and then pressed &lt;enter&gt;  
...
Once in vim I typed ":/index1" and pressed "n" 8 times ("n""n""n""n""n""n""n""n") to go to the correct occurence of "index1". Then I pressed the right arrow 5 times (&lt;right&gt;&lt;right&gt;&lt;right&gt;&lt;right&gt;&lt;right&gt;) and typed "r" and then "2" to replace the "1" with a "2". Then I pressed &lt;escape&gt; and typed ":wq" and hit &lt;enter&gt; to save and quit.  
...
**Step 9:**  
Keys: I typed "git commit -a -m 'Fixed'" to commit the changes. Then I typed "git push" and pressed &lt;enter&gt;.  
