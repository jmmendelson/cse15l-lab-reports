...
**Step 5:**  
Keys:  I typed "git clone" and pressed cmnd-V to paste "https://github.com/jmmendelson/lab7.git" and then pressed <enter>
<img width="488" alt="Screen Shot 2023-11-19 at 10 56 16 PM" src="https://github.com/jmmendelson/cse15l-lab-reports/assets/130113062/bc7c5557-4f03-4993-97ce-2be68bfad406">  
...
Once in vim I typed ":/index1" and pressed "n" 8 times ("n""n""n""n""n""n""n""n") to go to the correct occurence of "index1". Then I pressed the right arrow 5 times 
(<right><right><right><right><right>) and typed "r" and then "2" to replace the "1" with a "2". Then I pressed <escape> and typed ":wq" and hit <enter> to save and quit.  
...
<img width="446" alt="Screen Shot 2023-11-19 at 11 12 39 PM" src="https://github.com/jmmendelson/cse15l-lab-reports/assets/130113062/7250beb8-0bf3-4b6c-beee-dd79d3220935">  
...
**Step 9:**  
Keys: I typed "git commit -a -m 'Fixed'" to commit the changes. I was unable to figure out how to use git push, but I would have type "git push" and then pressed <enter>.  
